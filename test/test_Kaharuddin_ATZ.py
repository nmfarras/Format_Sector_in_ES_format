...
"""
Kaharuddin ATZ :
A circle with radius 5 NM centred on ARP

Kaharuddin ARP
082919S 1172451E
"""

case_name = "Kaharuddin_ATZ"

# Define circle center and radius
center_point = dms_to_decimal("082919S 1172451E")
...
plt.plot(lons, lats, marker='o', linestyle='-', label='Kaharuddin ATZ')
plt.scatter(center_point.longitude, center_point.latitude, color='red', label='Kaharuddin ARP', s=100)
