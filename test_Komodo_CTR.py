...
"""
Komodo CTR :
A circle with radius of 30 NM centred on LBJ VOR/DME

LBJ VOR/DME
S0082853 E1195305
"""

case_name = "Komodo_CTR"

# Define circle center and radius
center_point = dms_to_decimal("082853S 1195305E")
...
plt.plot(lons, lats, marker='o', linestyle='-', label='Komodo CTR')
plt.scatter(center_point.longitude, center_point.latitude, color='red', label='LBJ VOR/DME', s=100)
